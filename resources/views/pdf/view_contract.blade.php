...
<div class="header">
    <table class="header-table">
        <tr>
            <td class="left-box">
                <img src="{{ public_path('storage/logo.jpg') }}" alt="Logo" />
            </td>
            <td class="center-box">
            </td>
            <td class="right-box">
                <div class="qr">
                    <img src="{{ $qrCodeSvg }}" alt="QR Code du contrat" />
                </div>
                <div class="date">
...
<div class="signature-wrapper">
    ...
    <div class="signature-section">
        <div class="signature-box">
            @if($contrat->signature_artiste_representant === true)
                <div class="stamp approved">Lu et approuvé</div>
            @elseif($contrat->signature_artiste_representant === false)
        ...
        <div class="signature-box">
            @if($contrat->signature_contractant === true)
                <div class="stamp approved">Lu et approuvé</div>
            @elseif($contrat->signature_contractant === false)
                <div class="stamp rejected">Rejeté</div>
            @else
                <div class="stamp empty">&nbsp;</div>
            @endif
