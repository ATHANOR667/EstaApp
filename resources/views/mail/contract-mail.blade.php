...
<div style="font-family: sans-serif; line-height: 1.6; color: #333;">
    ...
    <p>Cher/chère {{ $contrat->prestation->nom_structure_contractante }},</p>
    ...
    <div style="text-align: center; margin: 30px 0;">
        <a href="{{ $signedUrl }}" style="background-color: #007bff; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">
