<div
    x-data="{ showModal: @entangle('showModal').live, errorOccurred: @entangle('errorOccurred').live, method: @entangle('method').live }"
    x-show="showModal"
            ...
            <form class="flex flex-col p-6">
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <div>
                        ...
                        />
                        @error('form.contractant_contact')
                ...
                <div class="bg-gray-50 dark:bg-gray-700 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6 mt-6 gap-3">
                    {{-- Boutons qui disparaissent au chargement --}}
