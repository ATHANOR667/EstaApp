...
<head>
    ...
    <script>
        window.Laravel = {
            userId: {{ Auth::guard('admin')->id() ?? 'null' }},
...
<nav class="bg-white dark:bg-gray-800 shadow-sm transition-colors duration-300 ease-in-out">
    <div class="container mx-auto px-4 py-3 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-6">
           ...
           <a href="{{route('admin.calendarView')}}" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200">Calendrier</a>
    ...
    <div x-show="sidebarOpen" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0"
        ...
        <a href="{{route('admin.calendarView')}}" class="block text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors duration-200 py-1">Calendrier</a>
