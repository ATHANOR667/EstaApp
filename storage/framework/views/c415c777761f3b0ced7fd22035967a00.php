<!DOCTYPE html>
<html lang="en" class="h-full" x-data="{ darkMode: localStorage.getItem('theme') === 'dark' || (!localStorage.getItem('theme') && window.matchMedia('(prefers-color-scheme: dark)').matches), sidebarOpen: false }" :class="{'dark': darkMode}">
<head>
    <meta charset="UTF-8">
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EstaApp\resources\views/super-admin/connected-base.blade.php ENDPATH**/ ?>