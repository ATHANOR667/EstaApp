<div>
    <div class="bg-white dark:bg-gray-800 p-4 sm:p-6 rounded-lg shadow-md transition-colors duration-300" style="background-color: rgba(<?php echo e($this->hex2rgb($artiste->couleur ?? '#f3f4f6')); ?>, 0.1);">
        <!--[if BLOCK]><![endif]--><?php if($artiste): ?>
            ...
            <div class="flex flex-col items-center sm:flex-row sm:items-start gap-4 sm:gap-6 mb-6 sm:mb-8 p-4 sm:p-6 rounded-lg shadow-lg opacity-50"
                 style="background-color: <?php echo e($artiste->couleur ?? '#f3f4f6'); ?>;">
                <!-- Artist's profile picture or initial avatar -->
                <!--[if BLOCK]><![endif]--><?php if($artiste->photo): ?>
                    <img src="<?php echo e(asset('storage/' . $artiste->photo)); ?>"
                ...
                <div class="flex-1 text-center sm:text-left mt-2 sm:mt-0">
                    <h2 class="text-xl sm:text-2xl font-bold text-white dark:text-gray-900 drop-shadow-lg">
                        Gérer l'équipe de <?php echo e($artiste->nom); ?>
            ...
            <div class="mb-6 sm:mb-8 border-b pb-6 sm:pb-8 border-gray-200 dark:border-gray-700">
                ...
                <div class="mt-4" wire:loading.class="opacity-50">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if($availableAdmins->count()): ?>
                        <!-- Mobile: Card layout -->
                        <div class="space-y-4 sm:hidden">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableAdmins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div wire:key="admin-<?php echo e($admin->id); ?>" class="p-4 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600">
                                    <div class="flex items-center justify-between">
                                        <div class="flex items-center space-x-3">
                                            <input type="checkbox" wire:click="toggleAdminToAdd(<?php echo e($admin->id); ?>)"
                                                   <?php if(in_array($admin->id, $adminsToAdd)): ?> checked <?php endif; ?>
                                                   class="form-checkbox h-4 w-4 text-blue-600 dark:text-blue-400">
                                            <!--[if BLOCK]><![endif]--><?php if($admin->photo_profil): ?>
                                                <img src="<?php echo e(asset('storage/' . $admin->photo_profil)); ?>" class="h-10 w-10 rounded-full object-cover" alt="Photo de profil">
                                            <?php else: ?>
                                            ...
                                            <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                            <span class="text-sm font-medium text-gray-900 dark:text-gray-100"><?php echo e($admin->prenom); ?> <?php echo e($admin->nom); ?></span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="hidden sm:block max-h-80 overflow-y-auto border border-gray-300 dark:border-gray-600 rounded-lg custom-scrollbar">
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                ...
                                <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $availableAdmins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr wire:key="admin-<?php echo e($admin->id); ?>" class="hover:bg-gray-100 dark:hover:bg-gray-700">
                        ...
                        <div class="mt-4">
                            <?php echo e($availableAdmins->links()); ?>
            ...
            <div>
                ...
                <!--[if BLOCK]><![endif]--><?php if($artiste->admins->count()): ?>
                    <!-- Mobile: Card layout -->
                    <div class="space-y-4 sm:hidden">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $artiste->admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div wire:key="team-admin-<?php echo e($admin->id); ?>" class="p-4 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700">
                                <div class="flex items-center justify-between">
                                    <div class="flex items-center space-x-3">
                                        <!--[if BLOCK]><![endif]--><?php if($admin->photo_profil): ?>
                                            <img src="<?php echo e(asset('storage/' . $admin->photo_profil)); ?>" class="h-12 w-12 rounded-full object-cover" alt="Photo de profil">
                                        <?php else: ?>
                                        ...
                                        <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                        <div>
                                            <p class="font-bold text-gray-900 dark:text-gray-100"><?php echo e($admin->prenom); ?> <?php echo e($admin->nom); ?></p>
                                            <p class="text-sm text-gray-500 dark:text-gray-300"><?php echo e($admin->matricule); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex space-x-2">
                                        <button wire:click="viewAdminDetails(<?php echo e($admin->id); ?>)"
                                        ...
                                        <button wire:click.prevent="removeAdminFromTeam(<?php echo e($admin->id); ?>)"
                    ...
                    <div class="hidden sm:grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $artiste->admins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $admin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div wire:key="team-admin-<?php echo e($admin->id); ?>" class="p-4 rounded-lg border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 flex flex-col items-center text-center">
                                <!--[if BLOCK]><![endif]--><?php if($admin->photo_profil): ?>
                                    <img src="<?php echo e(asset('storage/' . $admin->photo_profil)); ?>" class="h-12 w-12 rounded-full object-cover mb-2" alt="Photo de profil">
                                <?php else: ?>
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EstaApp\resources\views/livewire/super-admin/manage-teams/team-manager.blade.php ENDPATH**/ ?>