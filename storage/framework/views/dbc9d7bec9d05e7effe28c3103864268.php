<div
    x-data="{ showModal: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?>.live, isViewing: <?php if ((object) ('isViewing') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isViewing'->value()); ?>')<?php echo e('isViewing'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isViewing'); ?>')<?php endif; ?>.live, contratId: <?php if ((object) ('contratId') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('contratId'->value()); ?>')<?php echo e('contratId'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('contratId'); ?>')<?php endif; ?>.live, showSendOptions: <?php if ((object) ('showSendOptions') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showSendOptions'->value()); ?>')<?php echo e('showSendOptions'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showSendOptions'); ?>')<?php endif; ?>.live, isGenerating: <?php if ((object) ('isGenerating') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isGenerating'->value()); ?>')<?php echo e('isGenerating'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('isGenerating'); ?>')<?php endif; ?>.live }"
    x-show="showModal"
    x-on:keydown.escape.window="$wire.closeModal()"
    class="fixed inset-0 z-50 overflow-y-auto"
    style="display: none;"
>
    <?php if (! $__env->hasRenderedOnce('ac3f0d23-60c2-4b91-b456-95890a44a658')): $__env->markAsRenderedOnce('ac3f0d23-60c2-4b91-b456-95890a44a658'); ?>
