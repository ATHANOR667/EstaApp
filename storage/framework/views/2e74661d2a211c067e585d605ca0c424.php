<div x-data="{ show: <?php if ((object) ('showModal') instanceof \Livewire\WireDirective) : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'->value()); ?>')<?php echo e('showModal'->hasModifier('live') ? '.live' : ''); ?><?php else : ?>window.Livewire.find('<?php echo e($__livewire->getId()); ?>').entangle('<?php echo e('showModal'); ?>')<?php endif; ?> }" x-show="show" x-cloak class="fixed inset-0 z-50 overflow-y-auto p-4">
        ...
        <div x-show="show" x-transition:enter="ease-out duration-300"
            ...
            <div class="flex items-center justify-between p-4 sm:p-6 border-b border-gray-200 dark:border-gray-700">
                <h3 class="text-xl sm:text-2xl font-extrabold text-gray-900 dark:text-gray-100">
                    <?php echo e($artisteId ? 'Éditer un Artiste' : 'Créer un Artiste'); ?>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="nom" wire:model.defer="nom"
                               class="w-full px-3 py-2 text-base rounded-lg border border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['nom'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                    ...
                    <div>
                        ...
                        <!--[if BLOCK]><![endif]--><?php if($newPhoto): ?>
                            <div class="mb-2">
                                <img src="<?php echo e($newPhoto->temporaryUrl()); ?>" class="h-16 w-16 object-cover rounded-full shadow-md" alt="Nouvelle photo">
                            </div>
                        <?php elseif($photo): ?>
                            <div class="mb-2">
                                <img src="<?php echo e(asset('storage/' . $photo)); ?>" class="h-16 w-16 object-cover rounded-full shadow-md" alt="Photo actuelle">
                            </div>
                        <?php else: ?>
                            <div class="mb-2 h-16 w-16 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center text-gray-500 dark:text-gray-300 font-bold">
                                <?php echo e(strtoupper(substr($nom, 0, 1))); ?>
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" id="couleur" wire:model.defer="couleur"
                                   class="w-12 h-8 rounded-md border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 <?php $__errorArgs = ['couleur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                            <div class="h-8 w-8 rounded-md" style="background-color: <?php echo e($couleur ?? '#9ca3af'); ?>"></div>
                        </div>
                        <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['couleur'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="mt-1 text-sm text-red-600 dark:text-red-400"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
                ...
                <div class="flex flex-col sm:flex-row justify-end space-y-3 sm:space-y-0 sm:space-x-3 mt-6">
                    ...
                    <button type="submit"
                        ...
                        <?php echo e($artisteId ? 'Sauvegarder' : 'Créer'); ?>
...
<?php /**PATH C:\Users\MARCAU\PhpstormProjects\EstaApp\resources\views/livewire/super-admin/manage-teams/artiste-form.blade.php ENDPATH**/ ?>